...
class BusinessProcessPolicy
{
    ...
    public function update(User $user, BusinessProcess $process): bool
    {
        return $this->write($user, $process->project);
    }

    public function changeStatus(User $user, BusinessProcess $process): bool
    {
        return $this->write($user, $process->project);
    }
