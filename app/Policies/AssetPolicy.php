...
class AssetPolicy
{
    ...
    public function update(User $user, Asset $asset): bool { return $this->write($user, $asset->project); }
    public function changeStatus(User $user, Asset $asset): bool { return $this->write($user, $asset->project); }
